...
export default function WorkProcess() {
  ...
  return (
    <section id="proses" className="relative py-24 bg-light-bg overflow-hidden">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    {/* Node Circle */}
                    <div className="w-[88px] h-[88px] rounded-full bg-white border-2 border-gold flex items-center justify-center text-gold relative z-10 shadow-md group-hover:bg-gold group-hover:text-white transition-all duration-300">
                      <IconComponent className="w-8 h-8" />
                    </div>

                    {/* Step Number Badge */}
                    <div className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-gold text-white font-sans text-[10px] font-bold flex items-center justify-center border border-white z-20 group-hover:bg-dark-deep group-hover:text-white transition-colors duration-300">
                      {step.stepNumber}
                    </div>
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    <p className="text-xs text-txt-secondary font-sans leading-relaxed px-4 md:px-0">
                      {step.description}
                    </p>
                  </div>
